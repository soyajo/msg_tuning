...
public class CtxConfig {
    ...
    public ChainedTransactionManager transactionManager(
            @Qualifier(FF2011JpaConfig.TransactionManager) PlatformTransactionManager txManager1,
            @Qualifier(OrasmsJpaConfig.TransactionManager) PlatformTransactionManager txManager2
    ) {
